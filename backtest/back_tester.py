...
from backtest.tools.data_reader import BackDataReader, PackageResourcesReader
...
from backtest.models.test_options import TestOptions, RoundDayOption
from backtest.test_runner import TestRunner
from backtest.tools.visualizer import Visualizer
...
class BackTester:
    ...
    def __get_data_reader(self, data_dir: Optional[Path]) -> BackDataReader:
        if data_dir is not None:
            from backtest.tools.data_reader import FileSystemReader
