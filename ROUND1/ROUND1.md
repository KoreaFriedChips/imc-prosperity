...
The first goods available for trade are **_Ash-Coated Osmium_** (`ASH_COATED_OSMIUM`) and **_Intarian Pepper Root_** (`INTARIAN_PEPPER_ROOT`). Devising a strategy to turn these products into profit should be your primary focus.
...
The Intarian people are kicking off your visit to Intara with two opening auctions for **_Dryland Flax_** (`DRYLAND_FLAX`) and **_Ember Mushrooms_** (`EMBER_MUSHROOM`).
